...
def binarize_per_slice(image, spacing,
                       intensity_th=-600, sigma=1, area_th=30,
    ...
    assert isinstance(intensity_th, int)
    ...
    nan_mask[nan_mask == 0] = np.nan  # 边界赋值nan
